...
def getExpectedTurns (lockId : Nat) : List Int :=
  ...
  | 400129 => [3, -2, 3, 2]
  | 1000 => [-3, 2, 3, 2, -3, 2, 0]
  | 1001 => [2, -3, 2, 3, 2, -3, 2, 0]
  | 1002 => [2, -3, 2, 3, 2, -3, 2]
  | 1003 => [3]
  | 1004 => [2, -3, 2, 3, 2, -3, 2, 0, 2, 3, -2]
  | 1005 => [-2, 3, 2, -3, 2, 3, 2, -3, 2, 0]
  | 1006 => [3, 2, -3, 2, 0]
  | 1007 => [-3, 2, 3, 2, -3, 2, 0, 2, 3, -2]
  | 1008 => [-3, 2, 0]
  | 1009 => [2, -3, 2, 3, 2, -3, 2, 0, 2]
  | 1010 => [-3, 2, 3, 2, -3, 2]
  | 1011 => [3, -2, 3, -2, 3, 2, -3, 2, 3, 2, -3]
  | 1012 => [-2, 3, -2, 3, 2, -3, 2, 3, 2, -3]
  | 1013 => [2, 3, -2, 3, -2, 3, 2, -3, 2]
  | 1014 => [3, -2, 3, -2, 3, 2, -3]
  | 1015 => [-2, 3, 2, -3, 2, 3, 2, -3, 2]
  | 1016 => [2, 3, -2, 3, -2]
  | 1017 => [-2, 3, 2, -3, 2, 3, 2, -3, 2, 0, 2, 3, -2]
  | 9999 => []
  | _      => []
